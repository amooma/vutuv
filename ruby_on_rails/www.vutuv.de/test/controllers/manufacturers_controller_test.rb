...
class ManufacturersControllerTest < ActionController::TestCase
  ...
  test "should create manufacturer" do
    assert_difference('Manufacturer.count') do
      post :create, manufacturer: { name: @manufacturer.name, url: @manufacturer.url, wikipedia_url: @manufacturer.wikipedia_url }
    end
  ...
  test "should update manufacturer" do
    patch :update, id: @manufacturer, manufacturer: { name: @manufacturer.name, url: @manufacturer.url, wikipedia_url: @manufacturer.wikipedia_url }
    assert_redirected_to manufacturer_path(assigns(:manufacturer))
  end
